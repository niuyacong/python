...
from datetime import datetime
dt=datetime(2015,2,1,15,15,15,200);
print(dt)
# 2015-02-01 15:15:15.000200
...
now=datetime.now();
print(now)
# 2018-02-07 14:21:55.142961
print(now+timedelta(hours=2));
# 2018-02-07 16:23:26.884208
print(now-timedelta(days=1))
# 2018-02-06 14:24:27.887698

print(now+timedelta(days=1,hours=2))
# 2018-02-08 16:25:02.101655
...
now=datetime.now();
print(now)# 2018-02-07 14:30:01.903802
print(now.replace(tzinfo= tz_utc_8)); # 强制设置为UTC+8:00
# 2018-02-07 14:31:11.821801+08:00
...
print(utc_dt)
# 2018-02-07 06:33:43.181459+00:00
# astimezone()将转换时区为北京时间:
bj_dt=utc_dt.astimezone(timezone(timedelta(hours=8)))
print(bj_dt)
# 2018-02-07 14:35:03.322042+08:00
# astimezone()将转换时区为东京时间:
tokyo_dt=utc_dt.astimezone(timezone(timedelta(hours=9)))
print(tokyo_dt)
# 2018-02-07 15:36:28.730928+09:00
# astimezone()将bj_dt转换时区为东京时间:
tokyo_dt2=bj_dt.astimezone(timezone(timedelta(hours=9)))
print(tokyo_dt2)
# 2018-02-07 15:39:59.402977+09:00
...
print(str_for('UTC+5:00'));
def to_timestamp(dt_str, tz_str):
    tz=int(str_for(tz_str))
    time=datetime.strptime(dt_str,'%Y-%m-%d %H:%M:%S');
    time_zone=time.astimezone(timezone(timedelta(hours=tz)))
    return time_zone.timestamp();

print(to_timestamp('2018-02-07 14:48:00','UTC+5:00'))
# 1517986080.0
